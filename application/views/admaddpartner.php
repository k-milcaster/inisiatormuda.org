<div class="content"><div class="ic"></div>
    <div class="container_12">
        <div class="grid_12">
            <h3><span>Add New Partner</span></h3></div>
        <div class="grid_6 prefix_1">            
            <form id="form" method="post" action="<?php echo base_URL(); ?>admin/doAddPartner" enctype="multipart/form-data">               
                <fieldset>
                    <label class="name">
                        <input type="text" name="name" placeholder="Partner Name:" class="field">
                        <br class="error">
